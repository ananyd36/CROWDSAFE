...
#     print(opt)
def camera_detect(model_def="config/yolov3_mask.cfg",weights_path="checkpoints/yolov3_ckpt_35.pth", class_path="data/mask_dataset.names", conf_thres=0.9,nms_thres=0.4,frame_size=416):
